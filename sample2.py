...
def plot_iss_on_map(m, latitude, longitude, icon_path):
    ...
    imagebox = OffsetImage(iss_icon, zoom=0.1)  # Adjust the zoom factor as needed
...
def main():
    ...
    # Provide the path to the ISS icon image (replace 'iss_icon.png' with your actual file name)
